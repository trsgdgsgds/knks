...
exports.run = async (client, message, args) => {
 ...
 if(!['registeryetkiliid'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
