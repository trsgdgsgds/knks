...
.setDescription(`<a:elmas:775837551470706700> Toplam Kayıtların: \`${kayıtlar}\`
<a:alev:775837529341558828> Toplam Erkek Kayıtların: \`${erkek}\`
<:697189772334071838:770989969480613888> Toplam Kadın Kayıtların: \`${kadın}\``)
.setFooter(`Register Of Bad`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
.setDescription(`<a:elmas:775837551470706700> Toplam Kayıtların: \`${kayıtlar1}\`
<a:alev:775837529341558828> Toplam Erkek Kayıtların: \`${erkek1}\`
<:697189772334071838:770989969480613888> Toplam Kadın Kayıtların: \`${kadın1}\``)
.setFooter(`BadTeam`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
